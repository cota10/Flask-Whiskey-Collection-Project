...
def create_whiskey(current_user_token):
    ...
    type_of_whiskey = request.json['type_of_whiskey']
    price = request.json['price']
    user_token = current_user_token.token

    print(f'BIG TESTER: {current_user_token.token}')

    whiskey = Whiskey(name, type_of_whiskey, price, user_token = user_token )
...
def update_whiskey(current_user_token,id):
    ...
    whiskey.type_of_whiskey = request.json['type_of_whiskey']
